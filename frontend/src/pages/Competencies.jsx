...
export default function Competencies() {
  ...
  return <>
    <header className="page-header"><div><span className="eyebrow">PLANEJAMENTO MENSAL</span><h1>Meses da escala</h1><p>Um mês preparado já nasce com todos os turnos: Dia (07h–19h) e Noite (19h–07h).</p></div></header>
